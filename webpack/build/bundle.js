...
/******/ 	var hotCurrentHash = "43c93a57a01909aee8eb"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var notificationAPI = {
	  ...
	  render: function render(options) {
	    ...
	    options.queue === true ? this.queueModeRender(options) : this.commonModeRender(options);
	  },
	  commonModeRender: function commonModeRender(options) {
	    var _this = this,
	        message,
	        type,
	        duration;
	    ...
	    if (document.getElementById('Notification')) {
	      ...
	      if (timers.waiting) {
	        ...
	        _this.removeDeadComponent(function () {
	          ...
	          ReactDOM.render(React.createElement(Notification, { type: type, message: message, duration: duration }), document.getElementById('NotificationContainer'));
	        });
	      }
	    } else {
	      document.body.appendChild(_this.container);
	  ...
	  queueModeRender: function queueModeRender(options) {
	    var _this = this,
	        current,
	        message,
	        type,
	  ...
	  createContainerDiv: function createContainerDiv() {
	  ...
	  removeDeadComponent: function removeDeadComponent(callback) {
	    timers.waiting = null;
	    ...
	    timers.end = setInterval(function () {
	      ...
	      if (opacity === 0) {
	        ...
	        timers.end = null;
	        ReactDOM.unmountComponentAtNode(notificationAPI.container);
	  ...
	  extend: function extend(options) {
	    if ((typeof options === 'undefined' ? 'undefined' : _typeof(options)) === 'object' && options.constructor === Object && Object.hasOwnProperty.call(options.constructor.prototype, 'isPrototypeOf')) {
	      this.customType.push(options);
	    } else {
	...
	notificationAPI.createContainerDiv();
	...
	var Notification = React.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    ...
	    var custom = notificationAPI.customType;
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { id: 'Notification', style: notificationStyle },
	      React.createElement(
	        'div',
	        { style: this.state.messageStyle, ref: 'div' },
	        this.props.message
	      )
	    );
	  },
